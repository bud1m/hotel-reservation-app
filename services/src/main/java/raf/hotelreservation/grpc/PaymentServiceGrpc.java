...
public final class PaymentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<raf.hotelreservation.grpc.PaymentRequest,
      raf.hotelreservation.grpc.PaymentResponse> getProcessPaymentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ProcessPayment",
      requestType = raf.hotelreservation.grpc.PaymentRequest.class,
      responseType = raf.hotelreservation.grpc.PaymentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<raf.hotelreservation.grpc.PaymentRequest,
      raf.hotelreservation.grpc.PaymentResponse> getProcessPaymentMethod() {
    io.grpc.MethodDescriptor<raf.hotelreservation.grpc.PaymentRequest, raf.hotelreservation.grpc.PaymentResponse> getProcessPaymentMethod;
      ...
      synchronized (PaymentServiceGrpc.class) {
        if ((getProcessPaymentMethod = PaymentServiceGrpc.getProcessPaymentMethod) == null) {
          PaymentServiceGrpc.getProcessPaymentMethod = getProcessPaymentMethod =
              io.grpc.MethodDescriptor.<raf.hotelreservation.grpc.PaymentRequest, raf.hotelreservation.grpc.PaymentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ProcessPayment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  raf.hotelreservation.grpc.PaymentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  raf.hotelreservation.grpc.PaymentResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void processPayment(raf.hotelreservation.grpc.PaymentRequest request,
        io.grpc.stub.StreamObserver<raf.hotelreservation.grpc.PaymentResponse> responseObserver) {
  ...
  public static final class PaymentServiceStub
    ...
    /**
     */
    public void processPayment(raf.hotelreservation.grpc.PaymentRequest request,
        io.grpc.stub.StreamObserver<raf.hotelreservation.grpc.PaymentResponse> responseObserver) {
  ...
  public static final class PaymentServiceBlockingStub
    ...
    /**
     */
    public raf.hotelreservation.grpc.PaymentResponse processPayment(raf.hotelreservation.grpc.PaymentRequest request) {
  ...
  public static final class PaymentServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<raf.hotelreservation.grpc.PaymentResponse> processPayment(
        raf.hotelreservation.grpc.PaymentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS_PAYMENT:
          serviceImpl.processPayment((raf.hotelreservation.grpc.PaymentRequest) request,
              (io.grpc.stub.StreamObserver<raf.hotelreservation.grpc.PaymentResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              raf.hotelreservation.grpc.PaymentRequest,
              raf.hotelreservation.grpc.PaymentResponse>(
  ...
  private static abstract class PaymentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return raf.hotelreservation.grpc.PaymentServiceOuterClass.getDescriptor();
    }
